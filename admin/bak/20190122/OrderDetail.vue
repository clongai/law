<template>
    <div>
        <div class="container">
            ...
            <!--success-->
            <el-card
                v-if="order.status == '1'||order.status == '2'||order.status == '4'||order.status == '5'||order.status == '8'||order.status == '9'"
                ...
                <el-row :gutter="20">
                    <el-col :span="6">
                        <div class="grid-content bg-purple">&nbsp;{{order.acceptDate}}</div>
                    </el-col>
                    <el-col :span="6">
            ...
            <el-row v-if="(order.status == '2' ||order.status == '15' )&& orginazation == '2'" type="flex" justify="space-around">
                ...
                <!-- <el-button type="danger" @click="pass2expert">转专家团队</el-button> -->
            </el-row>
            ...
            <!--市场部人员&专家团队操作按钮-->
             <el-row v-else-if="order.status == '7'" type="flex" justify="space-around">
                <el-button type="warning" @click="accept">接受</el-button>
                <el-button type="danger" @click="refuse">拒绝</el-button>
            </el-row>
        ...
        <el-dialog title="预约电话沟通时间补充信息" :visible.sync="phoneAppointmentVisible" width="50%">
            <el-form ref="phoneAppointmentForm" :model="phoneAppointmentForm" :rules="rules" label-width="100px">
                ...
                <el-form-item label="联系人">
                    <el-input v-model="phoneAppointmentForm.acceptContacts"></el-input>
                </el-form-item>
        ...
        <el-dialog title="接受报单需补充下列面谈信息" :visible.sync="acceptVisible" width="50%">
            <el-form ref="acceptform" :model="acceptform" :rules="rules" label-width="90px">
                ...
                <el-form-item v-if="orginazation == '1'" prop="caseBaseLevel" label="案由大类">
                    <!--<el-input v-model="acceptform.caseBaseLevel"></el-input>-->
                ...
                <el-form-item v-if="orginazation == '1'" prop="caseSubLevel" label="案由小类">
                    <!--<el-input v-model="acceptform.caseSubLevel"></el-input>-->
                ...
                <el-form-item label="面谈时间一">
                    <el-date-picker type="datetime" placeholder="开始日期" v-model="acceptform.acceptStartTime1"
                                    value-format="yyyy-MM-dd HH:mm:ss" style="width: 45%;"></el-date-picker>
                ...
                <el-form-item label="联系人">
                    <el-input v-model="acceptform.acceptContacts"></el-input>
                </el-form-item>
                <el-form-item label="联系电话">
        ...
        <el-dialog title="请确定面谈时间点" :visible.sync="lawWorkAcceptVisible" width="50%">
            <el-form ref="lawWorkAcceptForm" :model="lawWorkAcceptForm" label-width="120px">
                <el-form-item label="编号">
    ...
    export default {
        ...
        methods: {
            ...
            downloadFile(e){
                ...
                window.location.href ='api/downloadFile?fileId='+e.currentTarget.getAttribute('attr');
                // this.$axios({
                //     method: 'post',
